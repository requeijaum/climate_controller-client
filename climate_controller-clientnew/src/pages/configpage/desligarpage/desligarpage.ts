...
@Component({
    selector: 'page-desligar',
    templateUrl: 'desligarpage.html',
    animations: [
    ...
    constructor (   public bluetoothSerial: BluetoothSerial, 
                    ...
                    enviaSolicitacaoGravacao() {
                        ...
                        this.loader = this.loadingCtrl.create({
                            content: "Aperte o botão de desligar do seu controle apenas uma vez e aguarde o dispositivo registrar...",
                        });
                        this.loader.present();
                        setTimeout( () => {
                    ...
                    animacaoBotao () {
                        if(!this.global.entrouPagDesligarPosSet && this.global.checksets.desligar_setado.state) {
                            this.global.entrouPagDesligarPosSet = true;
                            this.global.buttonDesligarPageState = 'end';
                        }
                        else if(!this.global.checksets.ligar_setado.state) {
                            this.global.entrouPagDesligarPosSet = false;
                            this.global.buttonDesligarPageState = 'start';
                        }
                    }
